...
export class QuizService  {
  ...
  private tagMap = {};
  listOfIds = [];
  private API_URL  =  'https://keoa9oi9a0.execute-api.us-east-1.amazonaws.com/default';
  private API_URL2 = 'https://k507yvzf3h.execute-api.us-east-1.amazonaws.com/default';
  ...
  getQuestion(id){
    ...
    return  this.httpClient.get(this.API_URL+'/GetQuestionDetail-DailyEquip?qid='+id);
}

getQuestionIds(){
  return  this.httpClient.get(this.API_URL2+'/GetAppQuestionsIds-DailyEquip');
}
